...
| P3 | **Sim-to-real learned insertion** — Isaac Lab RL policy + VLA fine-tune vs classical spiral-search compliance, on the real arm, across misalignment/lighting/latency — **with per-joint current sensing as the force signal (the field entry in the ForceVLA conversation: lab papers have F/T sensors, field arms have current — see research/RESEARCH-RADAR.md §2)**. Honest negative results welcome; the ablation is the contribution | Real arm + Phase 3 autonomy stack | **Jun–Sep 2027** | CoRL 2027 (ddl ~Jun) / RA-L |
...
| P5 | **Residual copilot for panel servicing under comms degradation** (sharpened 2026-07-07, RADAR §5 — the corner PATO/Stiffness-Copilot leave empty): train assistance from our competition teleop corpus; evaluate operator+copilot vs operator-alone across injected latency/dropout. Doubles as our IRC degraded-comms fallback. (Edge-VLA distillation demoted to a section if results warrant) | Full 2027 season infrastructure | **Feb–May 2028** | IROS 2028 / RA-L / iSpaRo 2028 |
